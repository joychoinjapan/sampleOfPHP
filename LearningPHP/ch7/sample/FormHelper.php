...
//$attributes 是个数组，存放例如 name->性别 value->男这类
//$isMultiple 是否有多个value值
//$valueAttribute 是否具有属性值
    protected function attributes(
        $attributes, $isMultiple, $valueAttribute = ture)
    {
        ...
        if ($valueAttribute &&
            ...
            array_key_exists($attributes['name'], $this->valus)) {
...
//$name $options
    ...
    protected function isOptionSelected($name,$value){
        ...
        // Otherwise, compare $value to the entry for $name in the values array
